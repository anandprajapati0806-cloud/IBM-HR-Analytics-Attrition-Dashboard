...
**Data folder** — contains hr_analytics_raw.csv (original dataset) and hr_analytics_clean.csv (cleaned dataset used for analysis)

**SQL folder** — contains IBM_HR_SQL_Analysis.sql with 13+ queries and findings written as comments

**PowerBI folder** — contains IBM_HR_Dashboard.pbix, the full interactive dashboard

**Visuals folder** — contains screenshots of all 5 dashboard pages

**Report folder** — contains IBM_HR_Data_Understanding, the data dictionary and project notes
